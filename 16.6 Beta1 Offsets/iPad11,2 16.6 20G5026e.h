...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a385ab0,
        .kernelcache__gPhysBase = 0xfffffff007908288,
        .kernelcache__gPhysSize = 0xfffffff007908288 + 8,
        .kernelcache__gVirtBase = 0xfffffff007906440,
        .kernelcache__perfmon_devices = 0xfffffff00a3c5530,
        .kernelcache__perfmon_dev_open = 0xfffffff007eca434,
        .kernelcache__ptov_table = 0xfffffff0078bb9a0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3c4910,
        .kernelcache__vm_pages = 0xfffffff0078b80f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ba950,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3c4908,
        .kernelcache__vn_kqfilter = 0xfffffff007f18c44,
    },
};
